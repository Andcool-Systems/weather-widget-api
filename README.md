...
> Внутренние ошибки бывают двух видов: на уровне облачной функции, обрабатываемые в try-except и на уровне шлюза. Ошибки на уровне шлюза обычно являются более критичными.

## Темы
### default
**Тема по умолчанию.**
*Описание было лень придумывать, пускай автор сам напишет здесь.*
